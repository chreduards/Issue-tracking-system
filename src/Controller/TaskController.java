...
public class TaskController extends DbManager {
    ...
    private final String TASK_ADDTASK = "INSERT INTO Task(processID, competenceID, taskName, budgetedTime, status) Values(?,?,?,?,?)";
    ...
    public void addTask(String taskName, int budgetedTime, int competenceID) throws SQLException{
        ...
        addTask.setInt(2, competenceID);
        addTask.setString(3, taskName);
        addTask.setInt(4, budgetedTime);
        addTask.setString(5, "Pending");
