...
public class ProcessController extends DbManager{
    ...
    private final String PROCESS_UPDATEPROCESS = "UPDATE Process SET pLeadId = ?, startDate = ?, processCategory = ?, "
            + "projectedDuration = ?, comments = ?, status = ? WHERE processID = ?";
    ...
    private final String PROCESS_ADDPROCESS = "INSERT INTO Process (pLeadId, startDate, processCategory, projectedDuration, comments, status) "
            + "Values(?,?,?,?,?,?)";
